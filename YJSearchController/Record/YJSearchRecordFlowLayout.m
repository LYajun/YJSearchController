...
@end
@implementation YJSearchRecordFlowLayout
...
- (void) calculateItemsWidths{
    ...
    for (NSInteger section = 0; section < self.collectionView.numberOfSections; section++) {
        ...
        for (NSInteger item = 0; item < [self.collectionView numberOfItemsInSection:section]; item++) {
            ...
            CGFloat itemWidth = [self.delegate lg_layout:self widthForItemAtIndexPath:itemIndex];
...
- (CGFloat) headerHeightForIndexPath:(NSIndexPath*)indexPath {
    if ([self.delegate respondsToSelector:@selector(lg_layout:heightForHeaderAtIndexPath:)]) {
        return [self.delegate lg_layout:self
    ...
    for (NSInteger section = 0; section < [self.collectionView numberOfSections]; section++) {
        for (NSInteger item = 0; item < [self.collectionView numberOfItemsInSection:section]; item++) {
            ...
            if (indexPath.item == 0) {
                ...
                titleAttributes.frame = CGRectMake(0, originY, YJSearchScreenW, height);
